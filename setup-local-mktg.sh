...
cp ~/adtalem-setup/setup-sync-mktg.sh ~/vms/CMS-Drupal-MKTG/scripts/setup-sync.sh
cp ~/adtalem-setup/bash_profile ~/vms/CMS-Drupal-MKTG/scripts/bash_profile
cp ~/adtalem-setup/local.config-mktg.yml ~/vms/CMS-Drupal-MKTG/box/local.config.yml
...
cp ~/adtalem-setup/.setup_vars ~/vms/CMS-Drupal-MKTG/vendor/acquia/blt/scripts/blt/setup_vars
cp ~/adtalem-setup/bash_profile_mktg ~/vms/CMS-Drupal-MKTG/vendor/acquia/blt/scripts/blt/bash_profile
cp ~/adtalem-setup/post-provision-mktg.php ~/vms/CMS-Drupal-MKTG/vendor/acquia/blt/scripts/drupal-vm/post-provision.php
...
[[ "$choice2" == [Yy]* ]] && bash ~/adtalem-setup/setup-vm-mktg.sh || exit 0